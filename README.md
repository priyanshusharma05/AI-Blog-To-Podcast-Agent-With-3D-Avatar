...
- `backend/services/`: Integrated backend pipeline for scraping, text processing, Gemini script generation, chat, and TTS
...
4. Gemini generates the podcast script and intro/outro in `backend/services/ai.py`.
